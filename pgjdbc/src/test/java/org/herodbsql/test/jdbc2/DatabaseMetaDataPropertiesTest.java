...
/*
 * TestCase to test the internal functionality of org.herodbsql.jdbc2.DatabaseMetaData's various
...
public class DatabaseMetaDataPropertiesTest {
  ...
  public void testDbProductDetails() throws SQLException {
    assertTrue(con instanceof org.herodbsql.PGConnection);
  ...
  public void testDriverVersioning() throws SQLException {
    ...
    assertEquals(org.herodbsql.util.DriverInfo.DRIVER_VERSION, dbmd.getDriverVersion());
    assertEquals(new org.herodbsql.Driver().getMajorVersion(), dbmd.getDriverMajorVersion());
    assertEquals(new org.herodbsql.Driver().getMinorVersion(), dbmd.getDriverMinorVersion());
