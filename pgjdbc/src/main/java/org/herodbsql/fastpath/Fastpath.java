...
package org.herodbsql.fastpath;
...
public class Fastpath {
   ...
   * backend.</p>
   *
   * <p>For an example of how this works, refer to org.herodbsql.largeobject.LargeObject</p>
   *
   * @param name Function name
   * @param args FastpathArguments to pass to fastpath
   * @return null if no data, byte[] otherwise
   * @throws SQLException if name is unknown or if a database-access error occurs.
   * @see org.herodbsql.largeobject.LargeObject
   */
   ...
   *
   * <p>The org.herodbsql.largeobject.LargeObject class performs a query upon it's startup, and passes
