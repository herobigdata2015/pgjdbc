...
import org.herodbsql.PGResultSetMetaData;
...
import org.herodbsql.util.HStoreConverter;
import org.herodbsql.util.PGbytea;
...
public class PgResultSet implements ResultSet, org.herodbsql.PGRefCursorResultSet {
  ...
  public java.net.URL getURL(int columnIndex) throws SQLException {
    ...
    checkClosed();
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getURL(int)");
  }
  ...
  public Blob getBlob(int i) throws SQLException {
    ...
    String typ = getMetaData().getColumnTypeName(i);
    if ("bytea".equalsIgnoreCase(typ)) {
      byte[] data = getBytes(i);
      Blob blob = new HerodbBlob();
  ...
  public Clob getClob(int i) throws SQLException {
    ...
    String typ = this.getMetaData().getColumnTypeName(i);
    if ("text".equalsIgnoreCase(typ)) {
      Clob clob = new HerodbClob();
  ...
  public Object getObjectImpl(int i, Map<String, Class<?>> map) throws SQLException {
    ...
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getObjectImpl(int,Map)");
  }
  ...
  public Ref getRef(int i) throws SQLException {
    ...
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getRef(int)");
  }
  ...
  public void updateRef(int columnIndex, Ref x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateRef(int,Ref)");
  }

  public void updateRef(String columnName, Ref x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateRef(String,Ref)");
  }

  public void updateBlob(int columnIndex, Blob x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateBlob(int,Blob)");
  }

  public void updateBlob(String columnName, Blob x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateBlob(String,Blob)");
  }

  public void updateClob(int columnIndex, Clob x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateClob(int,Clob)");
  }

  public void updateClob(String columnName, Clob x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateClob(String,Clob)");
  }
  ...
  public void updateObject(int columnIndex, Object x, java.sql.SQLType targetSqlType,
    ...
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateObject");
  }
  ...
  public RowId getRowId(int columnIndex) throws SQLException {
    ...
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getRowId(int)");
  }
  ...
  public void updateRowId(int columnIndex, RowId x) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateRowId(int, RowId)");
  }
  ...
  public int getHoldability() throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getHoldability()");
  }
  ...
  public void updateNString(int columnIndex, String nString) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateNString(int, String)");
  }
  ...
  public void updateNClob(int columnIndex, NClob nClob) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateNClob(int, NClob)");
  }
  ...
  public void updateNClob(int columnIndex, Reader reader) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateNClob(int, Reader)");
  }
  ...
  public void updateNClob(int columnIndex, Reader reader, long length) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateNClob(int, Reader, long)");
  }
  ...
  public NClob getNClob(int columnIndex) throws SQLException {
    ...
    String typ = this.getMetaData().getColumnTypeName(columnIndex);
    if ("text".equalsIgnoreCase(typ)) {
      NClob clob = new HerodbClob();
      String str = getString(columnIndex);
      clob.setString(1, str);
      return clob;
    } else {
      throw org.herodbsql.Driver.notImplemented(this.getClass(), "getNClob(int)");
    }
  }
  ...
  public void updateBlob(int columnIndex, InputStream inputStream, long length)
      throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(),
  ...
  public void updateBlob(int columnIndex, InputStream inputStream) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateBlob(int, InputStream)");
  }
  ...
  public void updateClob(int columnIndex, Reader reader, long length) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateClob(int, Reader, long)");
  }
  ...
  public void updateClob(int columnIndex, Reader reader) throws SQLException {
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "updateClob(int, Reader)");
  }
  ...
  public String getNString(int columnIndex) throws SQLException {
    ...
    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getNString(int)");
  }
...
//    throw org.herodbsql.Driver.notImplemented(this.getClass(), "getNCharacterStream(int)");
