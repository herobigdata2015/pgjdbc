...
public class GT {
  ...
  private GT() {
    try {
      ...
      bundle = ResourceBundle.getBundle("org.herodbsql.translation.messages");
      //#else
      bundle = ResourceBundle.getBundle("org.herodbsql.translation.messages", Locale.getDefault(Locale.Category.DISPLAY));
      //#endif
