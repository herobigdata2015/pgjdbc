...
package org.herodbsql.ds.common;

import org.herodbsql.ds.PGConnectionPoolDataSource;
import org.herodbsql.ds.PGPoolingDataSource;
import org.herodbsql.ds.PGSimpleDataSource;
...
public class PGObjectFactory implements ObjectFactory {
  ...
  public Object getObjectInstance(Object obj, Name name, Context nameCtx,
    ...
    if (className.equals("org.herodbsql.ds.PGSimpleDataSource")
        || className.equals("org.herodbsql.jdbc2.optional.SimpleDataSource")
        || className.equals("org.herodbsql.jdbc3.Jdbc3SimpleDataSource")) {
      return loadSimpleDataSource(ref);
    } else if (className.equals("org.herodbsql.ds.PGConnectionPoolDataSource")
        || className.equals("org.herodbsql.jdbc2.optional.ConnectionPool")
        || className.equals("org.herodbsql.jdbc3.Jdbc3ConnectionPool")) {
      return loadConnectionPool(ref);
    } else if (className.equals("org.herodbsql.ds.PGPoolingDataSource")
        || className.equals("org.herodbsql.jdbc2.optional.PoolingDataSource")
        || className.equals("org.herodbsql.jdbc3.Jdbc3PoolingDataSource")) {
