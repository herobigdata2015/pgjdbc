...
public abstract class BaseDataSource implements CommonDataSource, Referenceable {
  ...
  static {
    try {
      ...
      throw new IllegalStateException(
        "BaseDataSource is unable to load org.herodbsql.Driver. Please check if you have proper PostgreSQL JDBC Driver jar on the classpath",
        e);
    }
  }
  ...
  public void setUrl(String url) {
    ...
    Properties p = org.herodbsql.Driver.parseURL(url, null);
  ...
  public java.util.logging.Logger getParentLogger() {
    return Logger.getLogger("org.herodbsql");
  }
  //#endif
