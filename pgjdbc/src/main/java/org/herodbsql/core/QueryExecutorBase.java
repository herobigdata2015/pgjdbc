...
public abstract class QueryExecutorBase implements QueryExecutor {
  ...
  protected QueryExecutorBase(PGStream pgStream, String user,
    ...
    this.reconnect = !"none".equalsIgnoreCase(info.getProperty("reconnect"));
  }
  ...
  public void sendQueryCancel() throws SQLException {
    ...
    try {
      ...
      cancelStream =
          new PGStream(pgStream.getSocketFactory(), pgStream.getHostSpec(), cancelSignalTimeout, reconnect);
   ...
   * @see org.herodbsql.PGConnection#getParameterStatuses
   * @see org.herodbsql.PGConnection#getParameterStatus
   */
