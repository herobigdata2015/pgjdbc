...
import org.herodbsql.jdbc.FieldMetadata;
...
public interface BaseConnection extends PGConnection, Connection {
   ...
   * the types registered via {@link org.herodbsql.PGConnection#addDataType(String, Class)} and
   * {@link org.herodbsql.PGConnection#addDataType(String, String)}.</p>
   *
   * <p>If no class is registered as handling the given type, then a generic
   * {@link org.herodbsql.util.PGobject} instance is returned.</p>
   *
