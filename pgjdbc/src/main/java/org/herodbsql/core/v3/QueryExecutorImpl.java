...
import org.herodbx.core.v3.JdbcMimeFile;
import org.herodbsql.PGProperty;
import org.herodbsql.copy.CopyIn;
import org.herodbsql.copy.CopyOperation;
import org.herodbsql.copy.CopyOut;
import org.herodbsql.core.CommandCompleteParser;
import org.herodbsql.core.Encoding;
import org.herodbsql.core.EncodingPredictor;
import org.herodbsql.core.Field;
import org.herodbsql.core.NativeQuery;
import org.herodbsql.core.Oid;
import org.herodbsql.core.PGBindException;
import org.herodbsql.core.PGStream;
import org.herodbsql.core.ParameterList;
import org.herodbsql.core.Parser;
import org.herodbsql.core.Query;
import org.herodbsql.core.QueryExecutor;
import org.herodbsql.core.QueryExecutorBase;
import org.herodbsql.core.ReplicationProtocol;
import org.herodbsql.core.ResultCursor;
import org.herodbsql.core.ResultHandler;
import org.herodbsql.core.ResultHandlerBase;
import org.herodbsql.core.ResultHandlerDelegate;
import org.herodbsql.core.SqlCommand;
import org.herodbsql.core.SqlCommandType;
import org.herodbsql.core.TransactionState;
import org.herodbsql.core.Tuple;
import org.herodbsql.core.Utils;
import org.herodbsql.core.v3.replication.V3ReplicationProtocol;
import org.herodbsql.jdbc.AutoSave;
import org.herodbsql.jdbc.BatchResultHandler;
import org.herodbsql.jdbc.TimestampUtils;
...
import org.herodbsql.util.PSQLWarning;
...
public class QueryExecutorImpl extends QueryExecutorBase {
  ...
  private void sendParse(SimpleQuery query, SimpleParameterList params, boolean oneShot)
    ...
    pgStream.sendInteger2b(params.getParameterCount()); // # of parameter types specified
    for (int i = 1; i <= params.getParameterCount(); ++i) {
  ...
  protected void processResults(ResultHandler handler, int flags) throws IOException {
    ...
    while (!endQuery) {
      ...
      switch (c) {
        case 'L': // file operation : modified:dfh
          pgStream.receiveInteger4(); // len, discarded
          JdbcMimeFile.JdbcFileOperation(pgStream);
          break;
  ...
  private void receiveAsyncNotify() throws IOException {
    ...
    addNotification(new org.herodbsql.core.Notification(msg, pid, param));
