...
import org.herodbsql.core.v3.TypeTransferModeRegistry;
import org.herodbsql.jdbc.AutoSave;
import org.herodbsql.jdbc.BatchResultHandler;
import org.herodbsql.jdbc.EscapeSyntaxCallMode;
...
public interface QueryExecutor extends TypeTransferModeRegistry {
   ...
   *        {@link org.herodbsql.core.Query#createParameterList()}.
   ...
   *        object returned by {@link org.herodbsql.core.Query#createParameterList()} created by
