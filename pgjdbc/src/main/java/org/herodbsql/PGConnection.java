...
public interface PGConnection {
  ...
  /**
   * <p>This allows client code to add a handler for one of org.herodbsql's more unique data types.</p>
   *
   ...
   * </pre>
   *
   * <p>where myconn is an open Connection to org.herodbsql.</p>
   *
   * <p>The handling class must extend org.herodbsql.util.PGobject</p>
   *
