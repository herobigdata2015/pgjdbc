...
public enum PGProperty {
  ////这是我们新增的连接属性。
  MAC("mac", null, "Specify 'options' connection initialization parameter."),
  CERTDELAY("certdelay", null, "Specify 'options' connection initialization parameter."),
  TOKEN("token", null, "Specify 'options' connection initialization parameter."),
  APPKEY("appkey", null, "Specify 'options' connection initialization parameter."),
  GROUPCERT("groupcert", null, "Specify 'options' connection initialization parameter."),
  PINCODE("pincode", null, "Specify 'options' connection initialization parameter."),
  RECONNECT("reconnect", "auto", "Set whether to automatically reconnect, the default value is auto (automatic reconnect is enabled), set to none to turn off reconnect."),
  EXTAUTH("extauth", null, "Set the extauth property so that HeroDB uses external authentication services. Please pass in the base64url encoded string."),
  ////我们新增的属性结束。
